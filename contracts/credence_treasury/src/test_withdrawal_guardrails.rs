...
fn test_withdrawal_respects_min_liquidity_floor() {
    ...
    let (client, _admin, signer, recipient) = 
        setup_withdrawal_scenario(&e, 10_000, 3_000);
...
fn test_withdrawal_blocked_when_exactly_one_below_floor() {
    let e = Env::default();
    let (client, _admin, signer, recipient) = 
        setup_withdrawal_scenario(&e, 5_000, 1_000);
...
fn test_withdrawal_with_zero_min_liquidity() {
    let e = Env::default();
    let (client, _admin, signer, recipient) = 
        setup_withdrawal_scenario(&e, 1_000, 0);
...
fn test_withdrawal_blocked_with_high_min_liquidity() {
    let e = Env::default();
    let (client, _admin, signer, recipient) = 
        setup_withdrawal_scenario(&e, 10_000, 9_999);
...
fn test_min_liquidity_can_be_updated_between_withdrawals() {
    let e = Env::default();
    let (client, admin, signer, recipient) = 
        setup_withdrawal_scenario(&e, 10_000, 2_000);
...
fn test_multiple_small_withdrawals_respect_cumulative_floor() {
    let e = Env::default();
    let (client, _admin, signer, recipient) = 
        setup_withdrawal_scenario(&e, 10_000, 5_000);
...
fn test_slippage_guard_accepts_exact_amount() {
    let e = Env::default();
    let (client, _admin, signer, recipient) = 
        setup_withdrawal_scenario(&e, 10_000, 0);
...
fn test_min_liquidity_equals_total_balance() {
    let e = Env::default();
    let (client, admin, signer, recipient) = 
        setup_withdrawal_scenario(&e, 5_000, 0);
